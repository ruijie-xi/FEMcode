function b = assemble_vector_2D_FE_2(rhs_fun,coe_num,mesh,mesh_test,...
    vec_FE_1,mesh_FE_1,vec_FE_2,mesh_FE_2,vec_info,Gauss_type)
% assemble vector with 2 FE functions.
...
for i_vec = 1:num_vec
    ...
    for n = 1:mesh.N_elem
        vec = coe_num(i_vec)*local_vector_FE_FE(n,rhs_fun,mesh,mesh_test,i_vec_test,dx_test,dy_test,...
