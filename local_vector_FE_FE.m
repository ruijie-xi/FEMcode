function vec = local_vector_FE_FE(i_elem,coe_fun,mesh,mesh_test,...
    i_vec_test,dx_test,dy_test,vec_FE_1,mesh_FE_1,i_vec_FE_1,dx_FE_1,dy_FE_1,...
    vec_FE_2,mesh_FE_2,i_vec_FE_2,dx_FE_2,dy_FE_2,Gauss_type)
...
vec = vec_1.*vec_2.*basis_test*(Gauss_weights.*coe_fun(Gauss_pts))';
